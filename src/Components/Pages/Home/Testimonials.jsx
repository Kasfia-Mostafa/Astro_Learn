import person1 from "../../../assets/Images/Avatar/person1.png";
import person2 from "../../../assets/Images/Avatar/person2.png";
import person3 from "../../../assets/Images/Avatar/person3.png";
  ...
  const testimonials = [
    {
      ...
      quote:
        "This platform didn’t just give me lessons; it gave me a roadmap. Within six months of finishing the Data Analytics path, I landed a junior role with a 40% salary increase.",
    },
    {
      avatar: person2,
      name: "Martin escobar",
      ...
      quote:
        "The mentorship here is what sets it apart. My mentor didn't just grade my code; they sat with me and explained the why behind the logic. That kind of insight is priceless.",
    },
    {
      avatar: person3,
      name: "Micheal worin",
      ...
      quote:
        "The instructors here are actually in the trenches. No fluff, just high-impact skills I could use at work the very next day. Best investment I've made in my professional development this year!",
    },
  ];

  return (
    <section className="relative py-14 my-60">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-600">
            Don’t just take our word for it. Join 50,000+ graduates who have
            already transformed their careers through our platform..
          </p>
        </div>
        <div className="mt-12">
          <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li
                key={idx}
                className="bg-beige rounded-xl border shadow-md border-teagreen"
              >
                <div className="p-4">
                  <svg
                ...
                <figure>
                  ...
                  <div className="flex items-center gap-x-4 p-4 mt-6 bg-teagreen">
                    <img
                      src={item.avatar}
                      className="w-16 h-16 rounded-full border-2 border-teagreen bg-beige"
                    />
                    <div>
      ...
      <div className="absolute top-0 w-full h-87.5"></div>
    </section>
  );
};
