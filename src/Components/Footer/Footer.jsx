...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500  px-4 py-5 max-w-screen-2xl mx-auto md:px-8">
        ...
        <div className="flex-1">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="max-w-sm flex items-center border rounded-md p-1">
              ...
              />
              <button className="p-2.5 rounded-md text-white bg-bronze outline-none shadow-md focus:shadow-none sm:px-5">
                Subscribe
              </button>
            </div>
          </form>
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2025 Astro Learn all rights reserved.
        </div>
