...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 bg-cornsilk">
      <nav
          ...
          <div>
            ...
            >
              <div className="relative">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="absolute top-0 bottom-0 w-6 h-6 my-auto text-gray-400 left-3 bg-cornsilk"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <input
                  type="text"
                  placeholder="Search"
                  className="w-full py-3 pl-12 pr-4 text-gray-500 border rounded-full outline-none bg-cornsilk focus:bg-cornsilk focus:border-teagreen"
                />
              </div>
            </form>
          </div>
          <div className="flex gap-3">
            <div className="items-center justify-end mt-6 space-y-6 md:flex md:mt-0">
              <a
                ...
                className="flex items-center justify-center gap-x-1 py-2 px-4 text-gray-900 font-medium bg-bronze rounded-full md:inline-flex"
              >
                Sign in
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="items-center justify-end mt-6 space-y-6 md:flex md:mt-0">
              <a
                href="javascript:void(0)"
                className="flex items-center justify-center gap-x-1 py-2 px-4 text-gray-900 font-medium bg-teagreen rounded-full md:inline-flex"
              >
                Sign up
                <svg
                  xmlns="http://www.w3.org/2000/svg"
